    // ? The following code is an AC solution that avoids cache misses.
    ...
    int main() {
        ...
        // ! The following code uses Coordinate compression for faster querying, although negligible improvement.
        // fastIO();
        // int n, q; cin >> n >> q;
